...
public class EspecieController {
      ...
      public ResponseEntity<Object> save(@Valid @RequestBody EspecieDTO especieDTO) throws JsonProcessingException {
          System.out.println(especieDTO.toJson());
      ...
      public ResponseEntity<Object> updateEspecie(@Validated(EspecieDTO.PutAndDelete.class) @RequestBody EspecieDTO especieDTO) throws JsonProcessingException{
        Optional<Especie> existingEspecie = especieService.findByDescripcion(especieDTO.getDescripcion());
        Response json = new Response();
        if(existingEspecie.isPresent()){
            json.setMessage("La especie ingresada ya existe");
